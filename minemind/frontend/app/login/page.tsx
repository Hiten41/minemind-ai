...
export default function LoginPage() {
  ...
  return (
    <main className="premium-bg noise-mask relative grid min-h-screen place-items-center overflow-hidden px-6 py-12 text-white">
      ...
      <motion.section
        ...
        className="glass-depth relative z-10 w-full max-w-[460px] rounded-[36px] p-7"
      >
        ...
        <div className="mt-6 text-center">
          <p className="tracked-label text-[10px] text-[#d7b779]/70">Private Access</p>
          <h1 className="mt-3 text-3xl font-semibold text-white">MineMind Vault</h1>
          <p className="mt-3 text-sm leading-6 text-white/46">
            Sign in to keep your uploaded documents, memory graph, and chat history isolated to your account.
          </p>
        </div>
        ...
        <form onSubmit={submit} className="mt-6 space-y-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 w-full rounded-full bg-[#d7b779] px-5 py-4 text-sm font-semibold text-black shadow-[0_0_42px_rgba(215,183,121,0.18)] transition hover:bg-white active:scale-[0.98] disabled:cursor-wait disabled:opacity-55"
          >
